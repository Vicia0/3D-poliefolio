      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-purple-500'>Polie</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I am a junior Full-Stack Engineer <br className='sm:block hidden' />
          ...
          <div className="flex gap-4">
            <button className='flex gap-2 p-1 bg-inherit hover:text-red-500 text-4xl md:text-5xl'
              onClick={() => window.open("https://github.com/Vicia0", "_blank")}>
              <AiFillGithub />
            </button>
            <button className='flex gap-2 p-1 bg-inherit hover:text-red-500 text-4xl md:text-5xl'
              onClick={() => window.open("https://www.linkedin.com/in/ishemezwe-polie-954022211/", "_blank")}>
              <AiFillLinkedin />
            </button>  
            <button className='flex gap-2 p-1 bg-inherit hover:text-red-500 text-4xl md:text-5xl'
